;; ADVENTURE TIEM
(defparameter *greeting* '(Welcome to Quest))

(defparameter *allowed-commands* '(drop look walk pickup inventory help quit))
...
(defun help ()
  (cons 'Commands- *allowed-commands*))

(defun inventory ()
  (cons 'Inventory- (objects-at 'body *objects* *object-locations*)))
