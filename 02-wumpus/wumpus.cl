...
(defun new-game ()
  ...
  (setf *player-pos* (find-empy-node))
  (setf *visited-nodes* (list *player-pos*))
  (draw-city)
  (draw-known-city))

(defun find-empy-node ()
  (let ((x (random-node)))
...
(defun handle-new-place (edge pos charging)
  (let* ((node (assoc pos *congestion-city-nodes*))
    ...
    (setf *player-pos* pos)
    (draw-known-city)
    (cond ((member 'cops edge) (princ "You ran into the cops. Game Over. You lose."))
          ((member 'wumpus node) (if charging
                                   (princ "You found the Wumpus! You win.")
                                   (princ "You ran into the Wumpus. You lose.")))
